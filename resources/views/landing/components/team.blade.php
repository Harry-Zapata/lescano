    ...
    <div class="container-fluid py-5" id="team">
        <div class="container py-5">
            <div class="section-title position-relative text-center">
                ...
                <h1 class="font-secondary display-4">Nuestro Equipo de Trabajo</h1>
            </div>
                    ...
                    <div class="row m-0">
                        <div class="col-sm-6 p-0 text-center">
                            <div class="h-100 d-flex flex-column justify-content-center bg-secondary p-4">
                                <h5 class="mb-2">{{$member->nombre}}</h5>
                                <p class="text-muted font-italic mb-2">{{$member->puesto}}</p>
                                <p>{{$member->texto}}</p>
                                <div class="position-relative mb-2">
                                    <a class="btn btn-outline-primary btn-square mr-1" href="{{$member->twitter}}" target="_blank"><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-outline-primary btn-square mr-1" href="{{$member->facebook}}" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-outline-primary btn-square mr-1" href="{{$member->instagram}}" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 p-0" style="min-height: 300px;">
                            <img class="position-absolute w-100 h-100" src="{{asset($member->imagen)}}" style="object-fit: cover;" alt="ima">
                        </div>
                    </div>
                </div>
            </div>
