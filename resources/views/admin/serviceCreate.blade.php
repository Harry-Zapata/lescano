...
@section('content')
    <form method="POST" action="{{ route('admin.services.store') }}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nombreModal" id="nombreModal">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <img src="" style="max-width: 200px; max-height: 200px" id="imagen-preview-modal" alt="Sin imagen">
        </div>
        <div class="mb-3">
            <label for="textoModal" class="form-label">Texto del Modal</label>
            <textarea class="form-control" name="textoModal" id="textoModal" rows="3"></textarea>
        </div>
